...
impl IssueType {
    pub fn id(self) -> &'static str {
        match self {
            ...
            IssueType::ThinContent => "thin_content",
    ...
    pub fn definition(self) -> IssueDefinition {
        let (label, severity, category, explanation, recommendation) = match self {
            ...
            IssueType::ThinContent => (
                ...
                IssueSeverity::Warning,
                IssueCategory::Content,
                "The page has very little body text for an indexable HTML page.",
                "Expand the page with useful, unique content that satisfies the search intent.",
            ),
            IssueType::KeywordCannibalization => (
